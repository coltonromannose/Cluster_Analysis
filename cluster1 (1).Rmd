...
```{r}
magdf <- read.csv("Employees.csv")


#create a data frame with only binary variables, Gender, real.estate, 
#purchaes, grad.degree, have.children by removing non binary columns
bindf <- magdf[c(1,16,20,25)]
View(bindf)
...
# This tells you a bit more about the specific clusters. 
